              ...
              if(!err) {
                ...
                _data.read('users', checkData.userPhone, (err, userData) => {
                  if(!err && userData) {
                    ...
                    const chechPosition = userChecks.indexOf(id);
                    if(chechPosition > -1) {
                      userChecks.splice(chechPosition, 1);
                      //Re-save user's data
                    ...
                    callback(500, {'Error' : 'Could not find the user who created the check, so could not remove the check on the user object'})
                  }
                });
              } else {
